      ...
      <div className="relative">
        ...
        {category.subcategories &&
          ...
          category.subcategories.docs.length > 0 && (
            <div
              className={cn(
                "opacity-0 absolute -bottom-3 w-0 h-0 border-l-[10px] border-r-[10px] border-b-[10px] border-l-transparent border-r-transparent border-b-black left-1/2 -transalte-x-1/2",
                isOpen && "opacity-100"
              )}
            />
          )}
